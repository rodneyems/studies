...
func (ec *executionContext) _Category_courses(ctx context.Context, field graphql.CollectedField, obj *model.Category) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCourse2ᚕᚖgraphqlᚋgraphᚋmodelᚐCourse(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNCourse2ᚕᚖgraphqlᚋgraphᚋmodelᚐCourse(ctx context.Context, sel ast.SelectionSet, v []*model.Course) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
